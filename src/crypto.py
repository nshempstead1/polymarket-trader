...
Provides encryption/decryption utilities for securely storing
private keys using Fernet symmetric encryption with PBKDF2 key derivation.
...
Example:
    ...
    # Load and decrypt
    manager.load_and_decrypt(password, "credentials/key.enc")
"""
