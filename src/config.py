...
class Config:
    ...
    def from_env(cls) -> "Config":
        ...
        signature_type = get_env_int("SIGNATURE_TYPE", 2)
        if clob_host:
            config.clob = ClobConfig(
                host=clob_host,
                chain_id=chain_id,
        ...
        elif chain_id != 137 or signature_type != 2:
            config.clob.chain_id = chain_id; config.clob.signature_type = signature_type
