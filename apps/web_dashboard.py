...
def get_usdc_balance():
    ...
    try:
        ...
        return contract.functions.balanceOf(Web3.to_checksum_address(WALLET)).call() / 1e6
    except Exception as e:
...
<body>
    <div class="container">
        <h1>🤖 Polymarket Trading Dashboard <span class="refresh-note">Auto-refresh: 30s</span></h1>
        
        <div class="stats-grid">
            <div class="card stat">
                <div class="stat-value positive">${{ "%.2f"|format(stats.usdc_balance) }}</div>
                <div class="stat-label">💰 USDC.e Balance</div>
            </div>
            <div class="card stat">
                <div class="stat-value">${{ "%.2f"|format(stats.total_portfolio) }}</div>
        ...
        <div class="tabs">
            <div class="tab active" data-tab="decisions" onclick="showTab('decisions')">📋 Decisions</div>
            <div class="tab" data-tab="trades" onclick="showTab('trades')">💰 Trades</div>
            <div class="tab" data-tab="positions" onclick="showTab('positions')">📈 Positions</div>
            <div class="tab" data-tab="strategies" onclick="showTab('strategies')">🎯 Strategies</div>
            <div class="tab" data-tab="rejections" onclick="showTab('rejections')">🚫 Rejections</div>
        </div>
            ...
            <div class="card">
                <table>
                    ...
                    <tr>
                        ...
                        <td>{{ "%.2f"|format((t.price or 0) * 100) }}¢</td>
            ...
            <div class="card">
                <table>
                    ...
                    <tr>
                        ...
                        <td>{{ "%.2f"|format((p.entry_price or 0) * 100) }}¢</td>
                        <td>{{ "%.2f"|format((p.exit_price or 0) * 100) }}¢</td>
...
def dashboard():
    ...
    stats = {
        ...
        "total_portfolio": usdc_balance + total_value,
